...
import 'PopSlider_controller.dart';
import 'PopSlider_options.dart';
import 'PopSlider_state.dart';
import 'utils.dart';

export 'PopSlider_controller.dart';
export 'PopSlider_options.dart';

typedef Widget ExtendedIndexedWidgetBuilder(
    BuildContext context, int index, int realIndex);

class NormalCarouselSlider extends StatefulWidget {
  ...
  @override
  NormalCarouselSliderState createState() =>
      NormalCarouselSliderState(_carouselController);
}

class NormalCarouselSliderState extends State<NormalCarouselSlider>
    with TickerProviderStateMixin {
  final CarouselControllerImpl carouselController;
  CarouselController _controllerNavigate = CarouselController();
  Timer? timer;
  ...
  NormalCarouselSliderState(this.carouselController);
  ...
  @override
  void didUpdateWidget(NormalCarouselSlider oldWidget) {
